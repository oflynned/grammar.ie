...
| **He/It**    | fairis  | fairis-san    | with/beside him  |
...
<MutationCard before={"Fara + duine"} after={"Fara duine"} title={"General"} rule={"No Mutation"}/>

* **General Rule** — *fara duine* — with a person — No lenition or eclipsis.
* **With the Article** — *fairis an* — with the — When combined with `an`, it often becomes `fairis an` (or `farais an`), without any mutation.
